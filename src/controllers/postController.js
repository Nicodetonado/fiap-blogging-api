...
const getAllPosts = async (req, res) => {
  try {
    ...
    const posts = await PostRepository.findPublished(options);
...
const searchPosts = async (req, res) => {
  try {
    ...
    const searchResults = await PostRepository.search(searchTerm, options);
...
const createPost = async (req, res) => {
  try {
    ...
    const savedPost = await PostRepository.create({
      title,
      content,
      author,
      tags: tags || [],
